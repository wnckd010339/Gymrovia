...
- 응답의 `expiresAt`은 시간대 오프셋을 포함한 ISO 8601 문자열입니다(예: `2026-09-03T06:10:00Z` 또는 `2026-09-03T15:10:00+09:00`). 주문 유효시간은 생성 시점부터 10분입니다.
- DB 주문 시간은 기존 앱 시간대 기준을 유지합니다. 운영 JVM 시간대를 임의로 변경하지 않으며, 승인 시 만료 비교에도 앱의 현재 시간을 사용합니다.
